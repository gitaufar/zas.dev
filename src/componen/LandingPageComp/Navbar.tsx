...
function Navbar() {
  ...
  return (
    <nav className="absolute w-full z-50 flex flex-row items-center">
      <div className="my-8 px-8 lg:px-20 flex fixed lg:static top-3 flex-row w-full justify-between"> 
        ...
        <BurgerMenu className="lg:hidden hidden scale-x-[-1] md:flex" color="white" size={10}/>
        <BurgerMenu className="flex scale-x-[-1] md:hidden" color="white" size={8}/>
      </div>
